...
//My population
	int people <- 100000; //min: 1 max: 100000; //Population
...
experiment HybridTB type: gui {
	...
	parameter 'Rate of recovered after treatment: gamma (I->R1)' type: float var:gamma <- 0.90 category: "Parameters"; //rate of recovered after treatment process
	parameter 'Rate of spontaneously recovered: sigma (I->R2)' type: float var: sigma<-0.50 category: "Parameters"; //rate of spontaneously recovered
	parameter 'Rate of contact' type: float var:alpha <-0.08 category: "Parameters"; //rate of contact
	parameter 'Rate of transmission: lambda' type: float var: lambda <- 0.080 category: "Parameters"; // rate of transmission
	...
	parameter 'Recovered after treatment: g1 (Le->R1)' type: float var: g1 <- 0.90  category: "Parameters"; //rate of recovered after treatment process from Le to R1
	parameter 'Recovered spontaneously: g2 (Le->R2)' type: float var: g2 <- 0.50  category: "Parameters"; // rate of spontaneously recovered from Le to R2
	parameter 'Recovered after treatment: k1 (Lf->R1)' type: float var: k1 <- 0.90 category: "Parameters"; //rate of recovered after treatment process from Lf to R1
	parameter 'Recovered spontaneously: k2(Lf->R2)' type: float var: k2 <- 0.50  category: "Parameters"; // rate of spontaneously recovered from Lf to R2
	parameter 'Rate of reactivation: r (R1 & R2 -> Le)' type: float var: r <- 0.0030  category: "Parameters"; // Rate of reactivation: r (R1 & R2 -> Le)
	parameter'Rate of treatment interuption: v (I->K)' type: float var: v <- 0.003  category: "Parameters"; //Rate of treatment interuption v (I->K)
...
// Graphique pour toutes les villes a la fois, donc toute la population
     ...
     // 	 grid model_grid lines: #black;
		...
		display All_City_Serie refresh_every: 1 {
			chart "All Cities" type: series background: rgb('white') {
		...
		display All_City_Camembert refresh_every: 1 {
			chart "All Cities " type: pie background: rgb('white') {
				data 'S' value: sum(ville collect each.S) color: #green ;				
				data 'I' value: sum(ville collect each.I) color: #red;
				data 'Le' value: sum(ville collect each.Le) color: #orange;
				data 'Lf' value: sum(ville collect each.Lf) color: #yellow ;				
			...
			chart "City 2" type: series background: rgb('white')  {
	...
	display City_3 refresh_every: 1 {
			chart "City 3" type: series background: rgb('white')  {
			...
			chart "City 4" type: series background: rgb('white')  {
		...
		display City_5 refresh_every: 1 {
			chart "City 5" type: series background: rgb('white')  {
	...
	display City_6 refresh_every: 1 {
			chart "City 6" type: series background: rgb('white')  {
